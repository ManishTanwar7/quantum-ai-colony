...
import { 
  BookOpen, CheckCircle2, Award, ChevronRight, Sparkles, 
...
export default function LearningHub() {
  ...
  const isCompleted = userProgress.completed_lessons?.includes(activeLesson.id);
    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all ${
                    selected
                      ? 'bg-gradient-to-r from-cyan-950/40 to-quantum-surface border-cyan-500/60 shadow-[0_0_15px_rgba(0,240,255,0.15)]'
                ...
                >
                  ...
                  <div className="font-bold text-sm text-slate-100 mt-1.5">
                    {lesson.title}
                  </div>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* Main Lesson Reader */}
          <div className="p-6 lg:p-8 rounded-2xl bg-quantum-surface border border-quantum-border space-y-6 shadow-xl">
            
            <div className="border-b border-quantum-border/60 pb-4">
            ...
            {activeLesson.theory_cards && activeLesson.theory_cards.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {activeLesson.theory_cards.map((card, idx) => (
                  <div key={idx} className="p-3.5 rounded-xl bg-quantum-dark/80 border border-quantum-border text-xs space-y-1">
          ...
          {activeLesson.quiz && activeLesson.quiz.length > 0 && (
            <div className="p-6 rounded-2xl bg-quantum-surface border border-quantum-border space-y-6 shadow-xl">
              ...
              <div className="flex items-center justify-between">
                ...
                {quizResult && (
                  <span className={`px-3 py-1 rounded-full text-xs font-bold font-mono ${
                    quizResult.passed ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/40' : 'bg-rose-500/20 text-rose-300 border border-rose-500/40'
                  }`}>
              ...
              <div className="space-y-6">
                {activeLesson.quiz.map((q, qIndex) => {
                  ...
                  const isCorrect = isSubmitted && selectedIdx === q.correct_index;

                  return (
                    <div key={q.id} className="p-4 rounded-xl bg-quantum-dark/80 border border-quantum-border space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        {q.options.map((opt, optIdx) => {
                          ...
                          let btnStyle = "bg-slate-900 border-slate-800 text-slate-300 hover:border-cyan-500/40";
                          ...
                          if (isSubmitted) {
                            ...
                            btnStyle = "bg-cyan-500/20 border-cyan-400 text-cyan-300 font-semibold";
                          }
              ...
              <div className="flex items-center justify-between pt-2">
                {quizResult ? (
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold text-xs rounded-xl shadow-lg transition-all"
                  >
